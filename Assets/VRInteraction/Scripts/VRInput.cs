...
namespace VRInteraction
{
	...
	public class VRInput : MonoBehaviour, IVRInput
	{
		public enum HMDType
		{
			VIVE,
		...
		public int g_padLeft
		{
			set { padLeft = value; }
			get { return padLeft; }
		}
		public int g_padRight
		{
			set { padRight = value; }
			get { return padRight; }
		}
		public int g_padBottom
		{
			set { padBottom = value; }
			get { return padBottom; }
		}
		public int g_padCentre
		{
			set { padCentre = value; }
			get { return padCentre; }
		}
		public int g_padTouch
		{
			set { padTouch = value; }
			get { return padTouch; }
		}
		public int g_gripKey
		{
			set { gripKey = value; }
			get { return gripKey; }
		}
		public int g_menuKey
		{
			set { menuKey = value; }
			get { return menuKey; }
		}
		public int g_aButtonKey
		{
			set { aButtonKey = value; }
			get { return aButtonKey; }
		}
		public int g_triggerKeyOculus
		{
			set { triggerKeyOculus = value; }
			get { return triggerKeyOculus; }
		}
		public int g_padTopOculus
		{
			set { padTopOculus = value; }
			get { return padTopOculus; }
		}
		public int g_padLeftOculus
		{
			set { padLeftOculus = value; }
			get { return padLeftOculus; }
		}
		public int g_padRightOculus
		{
			set { padRightOculus = value; }
			get { return padRightOculus; }
		}
		public int g_padBottomOculus
		{
			set { padBottomOculus = value; }
			get { return padBottomOculus; }
		}
		public int g_padCentreOculus
		{
			set { padCentreOculus = value; }
			get { return padCentreOculus; }
		}
		public int g_padTouchOculus
		{
			set { padTouchOculus = value; }
			get { return padTouchOculus; }
		}
		public int g_gripKeyOculus
		{
			set { gripKeyOculus = value; }
			get { return gripKeyOculus; }
		}
		public int g_menuKeyOculus
		{
			set { menuKeyOculus = value; }
			get { return menuKeyOculus; }
		}
		public int g_aButtonKeyOculus
		{
			set { aButtonKeyOculus = value; }
			get { return aButtonKeyOculus; }
		}
		...
		{
			get { return controller.padTouched; }
		}
		...
		protected virtual void OnEnable()
		{
			...
			controller.PadTouched += TrackpadTouch;
			controller.PadUntouched += TrackpadUnTouch;
		...
		void TrackpadTouch(object sender, ClickedEventArgs e)
		{
			...
			if (!mirrorControls && hmdType == HMDType.OCULUS) touchKey = this.padTouchOculus;
		...
		void TrackpadUnTouch(object sender, ClickedEventArgs e)
		{
			int touchKey = this.padTouch;
			if (!mirrorControls && hmdType == HMDType.OCULUS) touchKey = this.padTouchOculus;
			if (touchKey >= VRActions.Length)
